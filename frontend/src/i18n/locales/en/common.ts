export default {
  ...
  imageStudio: {
    ...
    blankTitle: 'Your images will appear here',
    blankDescription: 'Enter a prompt and choose your settings to begin.',
    capabilitiesUnavailable: 'Image controls are unavailable for this API key.',
    generationFailed: 'The image could not be generated. Try again manually.',
    partialResult: 'Some images could not be generated.',
    resultAlt: 'Generated image',
    uploadImages: 'Source images',
    uploadHint: 'Choose images or drag and drop them here',
    removeImage: 'Remove image',
    editPrompt: 'Edit instructions',
    editPromptPlaceholder: 'Describe the changes you want to make',
    edit: 'Edit image',
    editing: 'Editing image',
    editBlankTitle: 'Edited images will appear here',
    editBlankDescription: 'Add source images and edit instructions to begin.',
    editFailed: 'The image could not be edited. Try again manually.',
    editThisImage: 'Edit this image',
    transferring: 'Preparing image',
    transferFailed: 'The image could not be prepared for editing.',
    transferFilename: 'image-studio-source',
    download: 'Download',
    ...
    uploadErrors: {
      ...
      fileSize: 'An image is too large.',
      totalSize: 'The images are too large together.',
    },
  },
