export default {
  ...
  imageStudio: {
    ...
    generate: '生成图像',
    generating: '正在生成图像',
    blankTitle: '生成的图像将显示在这里',
    blankDescription: '输入提示词并选择设置后开始生成。',
    capabilitiesUnavailable: '此 API 密钥暂无可用的图像控件。',
    generationFailed: '图像生成失败，请手动重试。',
    partialResult: '部分图像生成失败。',
    resultAlt: '生成的图像',
    uploadImages: '源图像',
    uploadHint: '选择图像或将图像拖放到此处',
    removeImage: '移除图像',
    editPrompt: '编辑说明',
    editPromptPlaceholder: '描述你想进行的修改',
    edit: '编辑图像',
    editing: '正在编辑图像',
    editBlankTitle: '编辑后的图像将显示在这里',
    editBlankDescription: '添加源图像并输入编辑说明后开始。',
    editFailed: '图像编辑失败，请手动重试。',
    editThisImage: '编辑此图像',
    transferring: '正在准备图像',
    transferFailed: '无法准备此图像进行编辑。',
    transferFilename: 'AI-生图源图',
    download: '下载',
    downloadAll: '全部下载',
